...
public final class FragmentCalculatorBinding implements ViewBinding {
  ...
  private FragmentCalculatorBinding(@NonNull FrameLayout rootView, @NonNull TextView textHome) {
  ...
  public static FragmentCalculatorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCalculatorBinding((FrameLayout) rootView, textHome);
    }
